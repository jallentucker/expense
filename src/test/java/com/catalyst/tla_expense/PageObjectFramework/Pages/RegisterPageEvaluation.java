...
public class RegisterPageEvaluation extends TestPageObject{
	...
	public void checkThatInvalidPasswordAndUsernameDisplaysErrorsAndStaysOnSamePage(){
	    ...
	    assertEquals("Please enter a valid password. Must have at least:<br> 8 characters, 1 capital character, 1 special characters and 1 number",actualEnterPasswordError);
